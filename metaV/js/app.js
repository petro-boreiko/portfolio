(() => {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        let buttons = document.querySelectorAll(".video-activity__button");
        let videos = document.querySelectorAll(".video-activity__item");
        let icons = document.querySelectorAll(".video-activity__icon");
        function playVideo(video, icon) {
            if (video.paused) {
                video.play();
                icon.src = "img/activity/pause-white.svg";
            } else {
                video.pause();
                icon.src = "img/activity/play.svg";
            }
        }
        function toggleVideoPlay(index) {
            let video = videos[index];
            let icon = icons[index];
            playVideo(video, icon);
        }
        ...
        videos.forEach((function(video, index) {
            ...
            video.addEventListener("play", (function() {
                icons[index].src = "img/activity/pause-white.svg";
                video.classList.add("video-active");
                video.closest(".video-activity").classList.add("video-active");
            }));
            video.addEventListener("pause", (function() {
                icons[index].src = "img/activity/play.svg";
                video.classList.remove("video-active");
                video.closest(".video-activity").classList.remove("video-active");
            }));
        }));
    }));
    window["FLS"] = false;
